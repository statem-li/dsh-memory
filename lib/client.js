		...
		*/
		...
		function BrainIcon({ size = 16 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				"aria-hidden": "true",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M6 2.6a2.2 2.2 0 0 0-3.9 1.5 2.5 2.5 0 0 0-.6 4.6 2.3 2.3 0 0 0 1 3.8 2.2 2.2 0 0 0 4.2.7" }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M10 2.6a2.2 2.2 0 0 1 3.9 1.5 2.5 2.5 0 0 1 .6 4.6 2.3 2.3 0 0 1-1 3.8 2.2 2.2 0 0 1-4.2.7" }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
						d: "M6.8 12.8c0-1.4.6-2.3 1.2-2.3s1.2.9 1.2 2.3",
						opacity: ".6"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
						d: "M8 2.5v9",
		...
		function MemoryPanel({ open, onClose, initialTab, t, ...api }) {
			...
			const handleDeleteChange = (change) => {
				run(() => api.deleteEntry(change.entryId));
			};
			/** 提交手动添加记忆。 */
			const saveAdd = () => {
			...
			const renderChange = (change) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				className: css.changeRow,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: css.changeBadge,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						tab === "all" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						state.status === "ready" && tab === "all" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							pinned.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							Object.keys(grouped).map((groupKey) => grouped[groupKey].length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: css.sectionTitle,
						...
						}), changes.length === 0 ? renderEmpty(t("changesEmpty")) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
							className: css.cardList,
							children: changes.map(renderChange)
						})] }),
